...
export default function Shop({ onAddToCart, setSelectedProduct, setCurrentPage }) {
  ...
  const handleProductSelect = (productId) => {
    // Only set if product is one of the 4 flavors (otherwise default to butterscotch details)
              ...
              <div style={styles.info}>
                ...
                <div style={styles.priceRow}>
                  <div style={styles.priceContainer}>
                    ...
                    {prod.saveAmount ? (
                      <span style={styles.saveBadge}>Save ₹{prod.saveAmount}</span>
                    ) : prod.savePercent ? (
                      <span style={styles.saveBadge}>Save {prod.savePercent}%</span>
                    ) : null}
                  </div>
                  <button
...
const styles = {
  shopPage: {
    ...
    paddingBottom: '8rem',
    backgroundColor: '#FFFFFF', // Clean white background per rules
    minHeight: '80vh',
  },
  shopHeader: {
    textAlign: 'center',
