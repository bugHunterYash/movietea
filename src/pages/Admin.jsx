...
// Mock initial data for products (matching atelier blends)
const INITIAL_PRODUCTS = [
  { id: 1, name: 'Rose Atelier', slug: 'rose-atelier', price: 219, discountPrice: 199, stock: 120, orderNumber: 1, category: 'Loose Leaf', flavorType: 'Floral', active: true, featured: true, desc: 'Premium black tea leaves infused with organic rose petals.', shortDesc: 'Delicate floral perfume in a cup.' },
  { id: 2, name: 'Cacao Reserve', slug: 'cacao-reserve', price: 199, discountPrice: 179, stock: 85, orderNumber: 2, category: 'Loose Leaf', flavorType: 'Decadent', active: true, featured: true, desc: 'Decadent union of roasted cacao husks and single-origin black tea.', shortDesc: 'Rich, dark, and deeply comforting.' },
  { id: 3, name: 'Vanilla Orchid', slug: 'vanilla-orchid', price: 199, discountPrice: 179, stock: 95, orderNumber: 3, category: 'Loose Leaf', flavorType: 'Warm', active: true, featured: true, desc: 'Organic black tea infused with premium Madagascar vanilla beans.', shortDesc: 'Silky smooth, warm orchid essence.' },
  { id: 4, name: 'Toasted Butterscotch', slug: 'toasted-butterscotch', price: 219, discountPrice: 199, stock: 64, orderNumber: 4, category: 'Loose Leaf', flavorType: 'Sweet', active: true, featured: true, desc: 'Infuse sweet toasted sugar notes, rich buttery warmth, and caramel glaze.', shortDesc: 'Golden caramel and rich buttery warmth.' }
];
...
export default function Admin() {
  ...
  const moveProduct = (index, direction) => {
    ...
    setProducts(updated.sort((a, b) => a.orderNumber - b.orderNumber));
  };
